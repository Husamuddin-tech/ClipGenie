...
export default function VideoFeed({
  ...
  {videos.length > 0 ? (
    ...
    <div className="col-span-full flex flex-col items-center justify-center py-16 rounded-3xl
                    bg-gradient-to-br from-pink-50 via-purple-50 to-blue-50
                    shadow-[0_0_20px_rgba(150,150,255,0.15)]
                    animate-fade-in transition-all duration-500">
      <span className="text-6xl mb-4 animate-bounce">📭</span>
      <p className="text-purple-600/80 font-semibold text-lg sm:text-xl">No videos found</p>
